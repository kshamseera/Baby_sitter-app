...
ActiveRecord::Schema.define(version: 2020_03_12_234927) do
  ...
  create_table "baby_sitter_registrations", force: :cascade do |t|
    t.bigint "user_id"
    t.string "country"
    t.string "city"
    t.string "language"
  ...
  create_table "booking_details", force: :cascade do |t|
    ...
    t.bigint "baby_sitter_registration_id", null: false
    t.string "name"
    t.string "age"
    t.string "number"
    t.string "city"
  ...
  add_foreign_key "baby_sitter_registrations", "users"
  add_foreign_key "booking_details", "baby_sitter_registrations"
